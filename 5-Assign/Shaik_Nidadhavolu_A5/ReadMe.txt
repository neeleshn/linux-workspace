...
3. Make a directory named input inside the main directory and copy contents of "all" directory inside Shaik_Nidadhavolu_A4/all
4. Run "Make assign5"
5. Find the output in output directory
